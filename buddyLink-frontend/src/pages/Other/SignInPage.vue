...
// DAY 格式化
// compute formatter listen to selectedDates
const formatter = computed(() => {
  ...
  return (day) => {
    ...
    // 判断当天日期是否在已选日期（签到日期）中
    // some 方法会遍历数组中的每个元素，直到找到一个满足条件的元素，然后返回 true，否则返回 false
    ...
    // 判断 各个日期有否签到 ，添加 topInfo and bottomInfo
    // 当天 , 小于今日，则判断 isInSelectedDates
